...
def get_args():
    ...
    parser.add_argument('--num_target_samples', type=int, default=15, help='test target samples')
    parser.add_argument('--second_order', type=str, default="False", help='use second order optimization')
    ...
    parser.add_argument('--num_samples_per_class', type=int, default=5, help='Number of samples per set to sample')
    parser.add_argument('--name_of_args_json_file', type=str, default="None")
    parser.add_argument('--warmup_dec_epoch', type=int, default=9, help='epochs before decision')
    parser.add_argument('--decision_freq', type=int, default=10, help='decision epochs')
    parser.add_argument('--rand', type=str, default="False")
    parser.add_argument('--retrain', type=str, default="False")

    parser.add_argument('--use_pretrained_model', type=str, default="False")
    parser.add_argument('--pretrained_model', type=str, default="")

    parser.add_argument('--make_decision', type=str, default="True")
    parser.add_argument('--use_ensemble', type=str, default="False")
    ...
    for key in list(args_dict.keys()):
        ...
        #     args_dict[key] += '_time_{}'.format(cur_time)
